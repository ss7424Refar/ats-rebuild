...
class DashBoard extends Common
{
    ...
    public function _initialize(){
        ...
        $this->toolArray = [JUMP_START, RECOVERY, C_TEST, TREBOOT, TAndD, FastBoot, BIOSUpdate, MT, HCITest, CommonTool];
...
//                ' and date(task_create_time) = curdate();', [$this->statusArray[$i]]);
            ...
            $res = Db::query('select count(*) as total from ats_task_basic where status = ? and tester = ?',
                        [$this->statusArray[$i], $this->loginUser]);
